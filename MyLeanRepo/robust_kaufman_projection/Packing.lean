...
/-!
# Packing and covering lemmas for the robust Kaufman projection theorem

Provides:
- Doubling property for covering numbers in the Euclidean plane (factor 9)
- Extraction of a maximal δ-separated subset with ball-growth from IsDeltaSSet
- Covering number monotonicity

Whiteprint node: packing
Dependencies: base
-/
