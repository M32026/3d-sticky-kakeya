...
namespace SeedMathlib.Analysis.Convex.MinkowskiCaratheodory
...
* `SeedMathlib.Analysis.Convex.MinkowskiCaratheodory.minkowski_theorem`:
  a compact convex set is the convex hull of its extreme points in finite
  dimension.
* `SeedMathlib.Analysis.Convex.MinkowskiCaratheodory.caratheodory_finite_convexHull`:
  a finite Caratheodory theorem using at most `finrank + 1` points.
* `SeedMathlib.Analysis.Convex.MinkowskiCaratheodory.mem_convexHull_finset_extremePoints_of_mem_compact_convex`:
...
end SeedMathlib.Analysis.Convex.MinkowskiCaratheodory
