...
`324 * rho^2`. -/
theorem pureWZ2_outerJohn_detENN_le
    {rho : ℝ}
    (hrho : 0 < rho)
    (hrhoOne : rho ≤ 1)
...
theorem pureWZ2_outerJohn_detENN_le_general
    {rho : ℝ}
    (hrho : 0 < rho)
    (parent : Kakeya.DeltaTube rho)
    (normalization : WZ2PaperAssouadUnitRescalingData parent) :
...
`324 * rho^2` in volume. -/
theorem pureWZ2_outerJohn_inverse_volume_le
    {rho : ℝ}
    (hrho : 0 < rho)
    (hrhoOne : rho ≤ 1)
    (parent : Kakeya.DeltaTube rho)
  ...
  rw [hlinear]
  gcongr
  exact pureWZ2_outerJohn_detENN_le
...
theorem pureWZ2_outerJohn_detENN_le_of_le_four
    {rho : ℝ}
    (hrho : 0 < rho)
    (hrhoFour : rho ≤ 4)
    (parent : Kakeya.DeltaTube rho)
...
theorem pureWZ2_outerJohn_inverse_volume_le_of_le_four
    {rho : ℝ}
    (hrho : 0 < rho)
    (hrhoFour : rho ≤ 4)
    (parent : Kakeya.DeltaTube rho)
  ...
  rw [hlinear]
  gcongr
  exact pureWZ2_outerJohn_detENN_le_of_le_four
