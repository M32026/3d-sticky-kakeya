import MyLeanRepo.Kakeya.Assouad.PureWZ2.C2.HorizontalFixedLineYSelection
import MyLeanRepo.Kakeya.Assouad.WZ1.Lemma23YLayerSelection
...
structure PureWZ2HorizontalFixedLineYResidueData
    ...
    (selection : PureWZ2HorizontalFixedLineYSelection parents) where
  residue : Fin 512
...
theorem PureWZ2HorizontalFixedLineYSelection.selectResidue
    {sigma inputLoss delta rho middleLoss outputLoss : ℝ}
    {logExponent : ℕ}
    {source : PureWZ2QuantitativeGrainConfiguration sigma inputLoss delta}
    {twoScale :
    ...
    Nonempty (PureWZ2HorizontalFixedLineYResidueData selection) := by
