import MyLeanRepo.Kakeya.Assouad.PureWZ2.C2.HorizontalFixedLineAlternativeA

/-!
# Balanced coarse-grain rho cells selected by Alternative-A heights
-/
...
structure PureWZ2HorizontalAlternativeARichCells
...
theorem PureWZ2HorizontalAlternativeAHeightData.toRichCells
    {sigma inputLoss delta rho middleLoss outputLoss eta theoremEta epsilon : ℝ}
    {logExponent : ℕ}
    {source : PureWZ2QuantitativeGrainConfiguration sigma inputLoss delta}
    {twoScale : PureWZ2OneScaleTwoScaleStickyData
  ...
  have hfiber : ∀ rhoCellValue ∈ rich.richF.image rhoCell,
    ...
    have hheightRange : fiber.image rich.heightIndex ⊆
      ...
      have hzClose :
        ...
        rw [wz1PaperGridCube_eq_Ico hrho (rhoCell basePoint)] at hfirstRho
        rw [wz1PaperGridCube_eq_Ico hrho (rhoCell basePoint)] at hsecondRho
        rw [abs_lt]
        constructor <;>
      ...
      have hindexReal :
        ...
        have hratio : prep.graphScale + rho <
          ...
          have hrhoSqrt : rho * Real.sqrt 3 < rho * 2 :=
            mul_lt_mul_of_pos_left hsqrt3 hrho
          nlinarith
  ...
  have hcellsSubset : cells ⊆ wz1PaperActiveCells residueShading.shading
      twoScale.coarseGrains.extremal.delta_pos := by
    intro cell hcell
